...
foreach($annonces as $annonce){ ?>
    <article class="annonce">
        ...
        <div class="art_icons"><a href="ajouter_favoris?id=<?= $annonce->id ;?>&datefavori=<?= $datefavori; ?>"><img title="Favoris" src="http://localhost:8000/assets/icons_logos/favorite.png" alt="star favorite"><a/></div>
        <p class="titre"><a href="article.php?id=<?= $annonce->id; ?>"><?= $annonce->titre; ?></a></p>
